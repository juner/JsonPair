...
#pragma warning disable CA1822 //Member 'SetOnlyValue' does not access instance data and can be marked as static [Juners.Json.Extensions.Tests]csharp(CA1822)
        public string SetOnlyValue { set { } }
#pragma warning restore CA1822 //Member 'SetOnlyValue' does not access instance data and can be marked as static [Juners.Json.Extensions.Tests]csharp(CA1822)
